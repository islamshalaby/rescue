    ...
    <div class="footer-wrapper">
        <div class="footer-section f-section-1">
            <p class="">{{ translate('copyright', 'layouts') }} © 2020
                <a target="_blank" class="website-link" href="https://u-smart.co/">{{ translate('usmart', 'layouts') }}</a>
                , {{ translate('all rights reserved', 'layouts') }}
            </p>
        </div>
    </div>
</div>
